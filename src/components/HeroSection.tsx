    ...
    <section className="min-h-screen flex items-center justify-center pt-20 pb-10 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto text-center relative z-10 max-w-4xl">
        ...
        >
          ...
          {/* <h1 className="text-sm md:text-4xl font-bold leading-tight mb-6 text-foreground">
           Meliora <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-600">Towards Better Things..</span>
          </h1>
          </i> */}
